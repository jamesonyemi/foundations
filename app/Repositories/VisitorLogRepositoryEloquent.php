...
class VisitorLogRepositoryEloquent implements VisitorLogRepository
{
    /**
     * @var VisitorLog
     */
    ...
    {
        return $this->model->where('company_id', $company_id)->whereYear('created_at', $date)->whereMonth('created_at', $date)->whereDay('created_at', $date)->with('employee');
    }
