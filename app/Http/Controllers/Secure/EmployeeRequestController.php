...
class EmployeeRequestController extends SecureController
{
    /**
    ...
    protected $module = 'employeeRequest';
    protected $activity;
    ...
    public function __construct(
        ...
        view()->share('type', 'employeeRequest');
        view()->share('link', 'employeeRequest');
    ...
    public function index()
    {
        ...
        $employeeRequests = EmployeeRequest::where('employee_id', session('current_employee'))
            ->get();

       return view('employeeRequest.index', compact('title', 'employeeRequests'));
    }
    ...
    public function create()
    {
        ...
        $employeeRequestCategories = EmployeeRequestCategory::get()
            ->map(function ($item) {
                return [
                    "id"   => $item->id,
                    "name" => $item->title,
        ...
        return view('employeeRequest.modal_form', compact('title', 'employees', 'employeeRequestCategories'));
    }
    ...
    public function store(EmployeeRequestRequest $request)
    {
        ...
        try
        {
            ...
            $employee_request->employee_request_category_id  = $request->employee_request_category_id ;
            $employee_request->employee_id = session('current_employee');
            $employee_request->company_year_id = session('current_company_year');
            $employee_request->title = $request->title;
            $employee_request->request_body = $request->request_body;
            $employee_request->status = 0;
            ...
            foreach ($validated['kt_docs_repeater_basic'] as $upload)
            {
                if (!empty($upload['document_title']) AND !empty($upload['file']))
                {
                    ...
                    $employeeRequestDocument = new EmployeeRequestDocument();
                    $employeeRequestDocument->employee_request_id = $employee_request->id;
    ...
    public function show(EmployeeRequest $employeeRequest)
    {
        ...
        return view('employeeRequest.modalShowApprove', compact('employeeRequest', 'title', 'action'));
    }
    ...
    {
        $title = 'Edit '. $employeeRequest->title.'';
        $employeeRequestCategories = EmployeeRequestCategory::get()
            ->map(function ($item) {
                return [
                    "id"   => $item->id,
        ...
        $employeeRequest_approvers = $employeeRequest->approvers()
            ->pluck('employee_id')
            ->toArray();

        $employeeRequest_copies = $employeeRequest->copies()
            ->pluck('employee_id')
            ->toArray();

        /*dd($employeeRequest_approvers);*/


        return view('employeeRequest.modal_form', compact('title', 'employeeRequest', 'employees', 'employeeRequestCategories', 'employeeRequest_approvers', 'employeeRequest_copies'));
    }
     ...
     * @return Response
     */
    public function update(EmployeeRequestRequest $request, EmployeeRequest $employeeRequest)
    {
        ...
        try
        {
            $employeeRequest->employee_request_category_id  = $request->employee_request_category_id ;
            $employeeRequest->employee_id = $request->employee_id ;
            $employeeRequest->title = $request->title;
            $employeeRequest->request_body = $request->request_body;
            $employeeRequest->status = 0;
            ...
            foreach ($validated['kt_docs_repeater_basic'] as $upload)
            {
                if (!empty($upload['document_title']) AND !empty($upload['file']))
                {
                    ...
                    $file->move($destinationPath, $document);
                    $employeeRequestDocument = new EmployeeRequestDocument();
                    $employeeRequestDocument->employee_request_id = $employeeRequest->id;
                    $employeeRequestDocument->document_title = $upload['document_title'];
                    $employeeRequestDocument->file = $document;
                    $employeeRequestDocument->save();
     ...
     * @return Response
     */
    public function delete(EmployeeRequest $employeeRequest)
    {
        try
        {

                DB::transaction(function() use ($employeeRequest) {
                    $employeeRequest->Comments()->delete();
                    $employeeRequest->approvers()->delete();
                    $employeeRequest->employeeRequestDocuments()->delete();
    ...
    {
        return view('employeeRequest.comments', compact('employeeRequest'));
    }
