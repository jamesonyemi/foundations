...
class CompanyController extends SecureController
{
    ...
    public function index()
    {
        ...
        return view('company.index', compact('title', 'schools'));
    }
    ...
    public function sector_company()
    {
        ...
        $companies = Company::where('sector_id', session('current_company_sector'))->get();

        return view('sector_company.index', compact('title', 'companies'));
    }
    ...
    public function show(Company $company)
    {
        ...
        return view('layouts.show', compact('company', 'title', 'action'));
    }
    ...
    public function edit(Company $company)
    {
        ...
        return view('company._form', compact('title', 'company', 'sectors', 'data'));
    }
    ...
    public function delete(Company $school)
    {
        ...
        return view('/company/delete', compact('school', 'title'));
    }
    ...
    {
        $title = $company->title.' Employees';
        $employees = $this->employeeRepository
            ->getAllForSchool($company->id)->where('status', 1)
            ->with('user')
            ->get();

        return view('company.employees', compact('title', 'employees', 'company'));
    }

    public function employeesPerformance(Company $company)
    {
        $title = $company->title.' Employees';
        $employees = $this->employeeRepository
            ->getAllForSchool($company->id)->where('status', 1)
    ...
    public function bscReview(Company $company)
    {
        $title = $company->title.' Employees';
        $employees = $this->employeeRepository
            ->getAllForSchool($company->id)->where('status', 1)
        ...
        return view('company.employeesBscReview', compact('title', 'employees', 'company'));
    }

    public function kpis(Company $company)
    {
        $title = $company->title.' Kpis';
        $kpis = Kpi::whereHas('employee', function ($q) use ($company) {
            $q->where('employees.company_id', $company->id)
                ->where('kpis.company_year_id', session('current_company_year'));
        })->get();

        return view('company.kpis', compact('title', 'kpis'));
    }


    public function KpiSignOff(Company $company)
    {
        $title = $company->title . ' BSC Signed Off Employees';
        $employees= Employee::where('employees.status', '=', 1)
            ...
            ->get();
        return view('company.kpiSignOffemployees', compact('title', 'employees'));
    }


    public function pendingKpiSignOff(Company $company)
    {
        $title = $company->title . ' BSC Signed Off Employees';
        $employees= Employee::where('employees.status', '=', 1)
            ->where('employees.company_id', $company->id)
    ...
    public function NoKpiSignOff(Company $company)
    {
        $title = $company->title . ' No BSC Employees';
    ...
    public function bscSelfReview(Company $company, KpiTimeline $timeline)
    {
        $title = $company->title . ' BSC Self Review Employees for '.$timeline->title;
        $employees= Employee::where('employees.status', '=', 1)->where('employees.company_id', $company->id)
            ->whereNull('employees.deleted_at')
    ...
    public function bscSupervisorReview(Company $company, KpiTimeline $timeline)
    {
        $title = $company->title . ' BSC Supervisor Review Employees for '.$timeline->title;
        $employees= Employee::where('employees.status', '=', 1)->where('employees.company_id', $company->id)->whereNull('employees.deleted_at')
            ->whereHas('KpiPerformanceReview.kpi',  function ($q) use($timeline)  {
                $q->where('kpi_performance_reviews.kpi_timeline_id', $timeline->id)
                    ->where('kpis.company_year_id', session('current_company_year'))
