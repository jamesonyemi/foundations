...
class QualificationFrameworkController extends SecureController
{
    /**
    ...
    public function __construct(
        ...
        view()->share('type', 'qualification_framework');
    }
    ...
    public function index()
    {
        ...
        return view('qualification_framework.index', compact('title'));
    }

    public function qualificationGap()
    {
        $title = 'Qualification Gaps';

        return view('qualification_gap.index', compact('title'));
    }
