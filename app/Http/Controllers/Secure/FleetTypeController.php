...
class FleetTypeController extends SecureController
{
    /**
     * @var LevelRepository
     */
    ...
    public function index()
    {
        ...
        return view('fleetType.index', compact('title', 'fleetTypes'));
    }
    ...
    public function create()
    {
        ...
        $fleetTypes = FleetType::get();
        return view('layouts.create', compact('title', 'fleetTypes'));
    }
     ...
     * @return Response
     */
    public function store(FleetTypeRequest $request)
    {
    ...
    public function show(FleetType $fleetType)
    {
        ...
        return view('layouts.show', compact('fleetType', 'title', 'action'));
    }
