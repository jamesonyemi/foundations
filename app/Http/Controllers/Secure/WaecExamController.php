...
class WaecExamController extends SecureController
{
    /**
    ...
    protected $activity;
    protected $module = 'Waec Exam';


    /**
     * BehaviorController constructor.
     * @param WaecExamRepository $behaviorRepository
     */
