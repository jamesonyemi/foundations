...
class FleetCategoryController extends SecureController
{
    /**
     * @var LevelRepository
     */
    ...
    public function create()
    {
        ...
        return view('layouts.create', compact('title', 'fleetCategories'));
    }
    ...
    public function store(FleetCategoryRequest $request)
    {
        ...
        try
        {
            DB::transaction(function() use ($request) {
                            ...
                            $procurementCategory = FleetCategory::firstOrCreate
                            (
                                [
