...
use App\Http\Requests\Secure\EmployeeIdeaRequest;
...
class EmployeeIdeaController extends SecureController
{
    /**
    ...
    public function __construct(
        ...
        view()->share('type', 'employeeIdea');
        view()->share('link', 'employeeIdea');
    ...
    public function index()
    {
        ...
        $employeeIdeaCampaigns = EmployeeIdeaCampaign::get();

       return view('employeeIdea.index', compact('title', 'employeeIdeaCampaigns'));
    }
    ...
    {
        $title = 'New Idea';
        $employee_idea_campaign_id = 31;


        return view('employeeIdea.modal_form', compact('title', 'employee_idea_campaign_id'));
    }


    public function createForCampaign(EmployeeIdeaCampaign $employeeIdeaCampaign)
    {
        $title = 'New Idea';
        $employee_idea_campaign_id = $employeeIdeaCampaign->id;
    ...
    public function store(EmployeeIdeaRequest $request)
    {
        ...
        try
        {
            $employeeIdea = EmployeeIdea::firstOrCreate(
                [

                    'title' => $request->title,
                    'company_year_id' => session('current_company_year'),
                    'employee_idea_campaign_id' => $request->employee_idea_campaign_id,
            ...
            foreach ($validated['kt_docs_repeater_basic'] as $upload)
            {
                if (!empty($upload['document_title']) AND !empty($upload['file']))
                {
                    ...
                    $employeeRequestDocument = new EmployeeIdeaDocument();
                    $employeeRequestDocument->employee_idea_id = $employeeIdea->id;
    ...
    public function show(EmployeeIdeaCampaign $employeeIdeaCampaign)
    {
        ...
        return view('employeeIdea.modalShowApprove', compact('employeeIdeaCampaign', 'title', 'action'));
    }
    ...
    public function edit(EmployeeRequest $employeeRequest)
    {
        ...
        return view('employeeIdea.modal_form', compact('title', 'employeeRequest', 'employees', 'employeeRequestCategories', 'employeeRequest_approvers', 'employeeRequest_copies'));
    }
