...
class ContactRequestController extends SecureController
{
    /**
    ...
    public function __construct(SchoolRepository $schoolRepository)
    {
        ...
        view()->share('type', 'contact_request');
    }
    ...
    public function index()
    {
        ...
        $contactDef = ContactRequest::select('id', 'name', 'email', 'category', 'details', 'created_at', 'status')
            ->orderBy('id', 'desc')->take(5)->get();

        return view('contact_request.index', compact('title', 'contactDef'));
    }
