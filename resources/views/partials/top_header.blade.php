<?php
$hrPolicies = \App\Models\HrPolicy::all();
$publicationCategories = \App\Models\PublicationCategory::all();
$externalApps = \App\Models\ExternalApp::all();
?>
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="/" class="d-lg-none">
                @if(!isset($school->photo))
                    <img src="{{ url('uploads/site').'/thumb_'.Settings::get('logo') }}" alt="logo"  class="h-30px"
                @else
                    <img src="{{ url('uploads/school_photo').'/'.$school->photo}}"  class="h-30px"
                        @endif />
            </a>
        </div>
        <!--end::Mobile logo-->
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                    ...
                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
                            ...
                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{ url('employee/employeeDataWizard') }}"   onclick="showDiv('{{ url('employee/employeeDataWizard') }}')">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                        <span class="menu-title">Update Your Data Sheet</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{ url('payroll/payslipIndex') }}" onclick="showDiv('{{ url('payroll/payslipIndex') }}')">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                        <span class="menu-title">Pay Slips</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{ url('legalRequest') }}" onclick="showDiv('{{ url('legalRequest') }}')">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                        <span class="menu-title">Legal Service Request</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{ url('employeeRequest') }}" onclick="showDiv('{{ url('employeeRequest') }}')">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
                            ...
                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{ url('helpDesk') }}"   onclick="showDiv('{{ url('helpDesk') }}')">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                      ...
                      @if($externalApps->count() > 0)
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
												<span class="menu-link py-3">
													<span class="menu-title">External Apps</span>
													<span class="menu-arrow d-lg-none"></span>
												</span>
                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                @foreach($externalApps as $key)
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{!empty($key->url) ? $key->url : ''}}" target="_blank" title="{{@$key->description}}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                        ...
                                        <span class="menu-title">{{@$key->title}}</span>
                                    </a>
                                </div>
                                @endforeach
                      ...
                      @endif
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
												<span class="menu-link py-3">
													<span class="menu-title">Policy Framework</span>
													<span class="menu-arrow d-lg-none"></span>
												</span>
                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                @foreach($hrPolicies as $key)
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{url('uploads/documents/'.$key->file)}}" >
															<span class="menu-icon">
                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
                            ...
                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                @foreach($publicationCategories as $key)
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{url('publication_category/'.$key->id.'/publications')}}" >
															<span class="menu-icon">
																<!--begin::Svg Icon | path: /icons/duotune/general/gen002.svg-->
																<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                @if(isset($company_years))
                <div class="dropdown">

                    <button class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary dropdown-toggle" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <span class="svg-icon svg-icon-2">
															...
															</span><span>{{$current_company_year}}</span>
                        <!--end::Svg Icon-->
                    </button>

                    <ul class="dropdown-menu menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px" aria-labelledby="dropdownMenuButton1">
                        <div class="menu-item px-3">
                            <div class="menu-content fs-6 text-dark fw-bolder px-3 py-4">Set Year</div>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <ul class="navi navi-hover py-4">
                            <!--begin::Item-->
                            @foreach($company_years as $year)
                                <li class="navi-item">
                                    <a href="{{url('/setyear/'.$year->id)}}" class="navi-link">
                                        <i class="menu-icon fa fa-calendar
                           {{ (($year->id==$current_company_year_id)?"text-success": "text-warning") }}">
                                        </i>
                                        <span class="navi-text">{{ ' ' }}{{$year->title }}</span>
                                    </a>
                                </li>
                                <div class="separator mb-3"></div>
                            @endforeach
...
<!--                <div class="d-flex align-items-center ms-1 ms-lg-3">
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="{{ url($user->picture) }}" alt="user" />
                    </div>
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{ url($user->picture) }}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                                    <div class="fw-bolder d-flex align-items-center fs-5">{{ Str::limit($user->full_name, 25) }}
                                        <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">Pro</span></div>
                                    <a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{ Sentinel::getUser()->email}}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
...
<!--                        <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
                            <a href="#" class="menu-link px-5">
													<span class="menu-title position-relative">Years
