...
?>
                            ...
                            <form action="{{ url()->current(). '/' .'generalExport' }}" method="post"  name="appfilter" id="appfilter">
                                ...
                                <div class="row">
                                    ...
                                    <select name="subject_id" class="form-control select2" id="subject_id" onChange="OpenAjaxPostCmd('{{ url('/ajax/'.$type) }}','result_container','appfilter','Please wait','result_container','1','2')">
                                    <option value="">{{trans('student.select_course')}}</option>
